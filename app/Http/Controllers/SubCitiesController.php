...
class SubCitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        $maxcityId = SubCities::max('id_city') ? SubCities::max('id_city') + 1 : 1;

        $cities = SubCities::all();
        return view('site.SubCities.subCitiesView', compact('cities', 'maxcityId', 'isCreate', 'isUpdate', 'isDelete', 'id_page'));
    }
