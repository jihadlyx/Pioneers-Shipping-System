                    ...
                    <table class="datatable-table table w-full table-auto" id="dataTableOne">
                        ...
                        @foreach($shipments as $index => $shipment)
                            <tr data-index="{{ $index }}">
                                ...
                                @if(Auth()->user()->id_type_users != 2 && $shipment->status_id != 1)
                                    <td class="text-center">
                                        {{ $shipment->statusShipment($shipment->status_id)->delegate->delivery_name }}
                                        <h5 class="font-medium text-black dark:text-white">0{{ $shipment->statusShipment($shipment->status_id)->delegate->phone_number }}</h5>
                                    </td>
                                @endif
