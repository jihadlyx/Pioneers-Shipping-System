        ...
        <div class="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
            <div class="mx-auto max-w-[490px]">
                ...
                <div class="mt-7.5 text-center">
                    ...
                    <p class="font-medium">
                        شكرا جزيلا على رسالتك. نحن نتحقق من البريد الإلكتروني بشكل متكرر وسنبذل قصارى جهدنا للرد على استفسارك.
                    </p>
                    <a href="{{ route('login') }}" class="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-opacity-90">
