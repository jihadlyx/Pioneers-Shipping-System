...
<div class="container">
    <div class="header">
        <svg xmlns="http://www.w3.org/2000/svg" width="176" height="32" viewBox="-50 0 1 32" fill="none">
{{--            <text x="-90" y="22" font-family="Arial" font-size="20" fill="white">لوحة التحكم</text>--}}
    ...
    <div class="content">
        ...
        <p>مرحبًا،</p>
        <p>
            لقد طلبت إعادة تعيين كلمة المرور الخاصة بك. يرجى الضغط على الزر أدناه
        ...
        <p>
            هذا الرابط صالح لمدة 2 دقيقتين فقط. إذا لم تطلب إعادة تعيين كلمة
            المرور، يرجى تجاهل هذا البريد الإلكتروني.
        </p>
        <p>شكرًا لك،<br />فريق الدعم</p>
    </div>
    <div class="footer">
        <p>© 2024 موقعك. جميع الحقوق محفوظة.</p>
    </div>
</div>
</body>
</html>
