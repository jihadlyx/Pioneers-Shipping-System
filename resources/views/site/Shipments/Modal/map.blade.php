    ...
    <div
        ...
        <div class=" flex items-center justify-between">
            ...
            <button onclick="closeModal()"
                    class=" absolute ltr:right-1 rtl:left-1 top-1 ltr:sm:right-5 rtl:sm:left-5 sm:top-5">
        ...
        <div class="mt-5 mb-2.5 flex gap-4 w-full">
            <div class="w-1/2">
                <input type="text" id="" placeholder="ادخل العنوان"
                       class="input-address w-full z-999999 rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
            </div>
