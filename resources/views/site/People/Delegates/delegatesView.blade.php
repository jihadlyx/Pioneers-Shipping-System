                                ...
                                <tr data-index="{{ $index }}">
                                    ...
                                    <td class="px-4 py-5">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            ...
                                            @if($isUpdate)
                                                <button data-target="EditDelegate{{ $delegate->id_delegate }}" class="hover:text-primary">
                                            ...
                                            @if($isDelete)
                                                <button data-target="DeleteDelegate{{ $delegate->id_delegate }}" class="hover:text-meta-1 button-icon">
                                    ...
                                    <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                        ...
                                        <h5 class="font-medium text-black dark:text-white">0{{ $delegate->phone_number2 }}</h5>
                                    </td>
                                    <td>
