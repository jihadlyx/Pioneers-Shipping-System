            ...
            <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                    @if($isCreate || $isShowTrash)
                        ...
                        @endif
                        @if($isShowTrash)
                            <a href="{{ route('delegates.getTrash', ["page_id" => 10]) }}"
                                ...
                                <tr data-index="{{ $index }}">
                                    <td class="px-4 py-5">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            @if($isUpdate)
                                                <button data-target="EditDelegate{{ $delegate->id_delegate }}" title="تعديل" class="hover:text-primary">
                                            ...
                                            @endif
                                            @if($isDelete && $delegate->isHasMany())
                                                <button data-target="DeleteDelegate{{ $delegate->id_delegate }}" title="حذف" class="hover:text-meta-1 button-icon">
                                    ...
                                    <td class="green">
                                        {{ $delegate->user($delegate->id_delegate)->email }}
                                    </td>
                                    <td>
                                        {{ $delegate->address }}
                                    </td>
