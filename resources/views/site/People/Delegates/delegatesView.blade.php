                                ...
                                <tr data-index="{{ $index }}">
                                    <td class="px-4 py-5">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            @if($isUpdate)
                                                <button data-target="EditDelegate{{ $delegate->delivery_id }}" title="تعديل" class="hover:text-primary">
                                            ...
                                            @if($isDelete && $delegate->isHasMany())
                                                <button data-target="DeleteDelegate{{ $delegate->delivery_id }}" title="حذف" class="hover:text-meta-1 button-icon">
                                    ...
                                    <td class="green">
                                        {{ $delegate->user($delegate->delivery_id)->email }}
                                    </td>
                                    <td>
                                        {{ $delegate->address }}
                                    </td>
