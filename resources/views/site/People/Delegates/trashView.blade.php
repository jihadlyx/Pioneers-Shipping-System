            ...
            <form id="TrashedForm" class="TrashedForm" method="POST">
                ...
                <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                    <div class="flex items-center gap-1 border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                        <button type="button" data-target="RestoreDelegate"
                        ...
                        <button type="button" data-target="DeleteTrashDelegate"
                    ...
                    @include('site.People.Delegates.modal.deleteTrash')
                    @include('site.People.Delegates.modal.restore')
                    ...
                    <div class="datatable-container">
                        <table class="datatable-table table w-full table-auto" id="dataTableOne">
                            ...
                            <tr>
                                ...
                                <th data-sortable="true" class="red" style="width: 10.225941422594143%">
                                    <a href="#" class="datatable-sorter">
                                        <div class="flex items-center gap-1.5">
                                            <p>العنوان</p>
                                            <div class="inline-flex flex-col space-y-[2px]">
                                    ...
                                    <td class="px-4 py-5 h-full">
                                        <div x-data="{ checkboxToggle: false }">
                                            <label for="checkboxLabelOneCreate{{ $index }}"
                                                ...
                                                <div class="relative">
                                                    <input class="hidden" name="delegates[{{ $index }}][id]" value="{{ $delegate->id_delegate }}">
                                                    <input type="checkbox" name="delegates[{{ $index }}][check]" id="checkboxLabelOneCreate{{ $index }}" class="sr-only"
