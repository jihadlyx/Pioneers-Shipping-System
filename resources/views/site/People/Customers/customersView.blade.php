...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav>
        <ol class="flex text-lg font-medium flex-wrap items-center gap-3">
            ...
            <li>
                <a class="flex items-center gap-3 font-medium" href="/customers">
                ...
                <table class="datatable-table table w-full table-auto" id="dataTableOne">
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" style="width: 18.80195258019526%">
                                <a href="#" class="datatable-sorter">
                                    <div class="flex items-center gap-1.5">
                        ...
                        <tr data-index="{{ $index }}">
                            <td class="px-4 py-5">
                                <div class="text-gray-100 flex items-center gap-1">
                                    @if($isUpdate)
                                        <button data-target="EditCustomer{{ $customer->customer_id }}" title="تعديل" class="hover:text-primary">
                                    ...
                                    @if($isDelete && $customer->isHasMany())
                                        <button data-target="DeleteCustomer{{ $customer->customer_id }}" title="حذف" class="hover:text-meta-1 button-icon">
                            ...
                            <td class="green">
                                {{ $customer->user($customer->customer_id)->email }}
                            </td>
                            <td>
                                {{ $customer->address }}
                            </td>
