                        ...
                        <tr data-index="{{ $index }}">
                            <td class="px-4 py-5">
                                <div class="text-gray-100 flex items-center gap-1">
                                    @if($isUpdate)
                                        <button data-target="EditCustomer{{ $customer->id_customer }}" title="تعديل" class="hover:text-primary">
                                    ...
                                    @if($isDelete && $customer->isHasMany())
                                        <button data-target="DeleteCustomer{{ $customer->id_customer }}" title="حذف" class="hover:text-meta-1 button-icon">
