<div id="RestoreCustomer{{ $customer->id_customer }}" x-transition=""
    ...
    <div class="w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
        ...
        <div class="-mx-3 flex flex-wrap gap-y-4">
            ...
            <div class="w-full px-3 2xsm:w-1/2">
                <form action="{{ route('customers.restore', ['page_id' => $id_page, 'id_customer' => $customer->id_customer]) }}" method="POST">
                    @csrf
                    @method("PATCH")
                    <button type="submit"
