                        ...
                        <tr data-index="{{ $index }}">
                            ...
                            <td class="px-4 py-5">
                                <div class="text-gray-100 flex items-center gap-1">
                                    @if($isUpdate)
                                        <button data-target="EditEmp{{ $employee->emp_id }}" title="تعديل" class="hover:text-primary">
                                    ...
                                    @if($isDelete)
                                        <button data-target="DeleteEmp{{ $employee->emp_id }}" title="حذف" class="hover:text-meta-1 button-icon">
                            ...
                            <td class="green">
                                {{ $employee->user($employee->emp_id)->email }}
                            </td>
                            <td>
                                {{ $employee->address }}
                            </td>
