        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                ...
                <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    ...
                    <!-- Dropdown Start -->
                    <div x-show="dropdownOpen"
                        class="absolute ltr:-right-16 rtl:left-0 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ltr:sm:right-0 rtl:sm:left-0 sm:w-80">
                        <div class="px-4.5 py-3">
