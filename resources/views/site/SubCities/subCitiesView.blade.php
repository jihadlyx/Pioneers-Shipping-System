    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex text-lg font-medium flex-wrap items-center gap-3">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="/subCities/6">
                        ...
                        <span class="hover:text-primary">اسعار التوصيل</span>
                    </a>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="flex items-center gap-1 border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                        @if($isCreate)
                            <button data-target="AddCity"
                                ...
                                إضافة مدينة او منطقة
                            </button>
                            @include('site.SubCities.modal.add')
                        @endif
                            @if($isShowTrash)
                                <a href="{{ route('subCities.getTrash', ["page_id" => 10]) }}"
                                ...
                                <tr data-index="{{$index}}">
                                    <td class="px-4 py-5">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            @if($isUpdate)
                                            <button data-target="EditCity{{ $city->region_id }}" title="تعديل" class="hover:text-primary">
                                            ...
                                            @endif
                                            @if($isDelete && $city->isHasMany())
                                                <button data-target="DeleteCity{{ $city->region_id }}" title="حذف" class="hover:text-meta-1 button-icon">
