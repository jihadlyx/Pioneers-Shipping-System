                                ...
                                <tr data-index="{{$index}}">
                                    <td class="px-4 py-5">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            @if($isUpdate)
                                            <button data-target="EditCity{{ $city->id_city }}" title="تعديل" class="hover:text-primary">
                                            ...
                                            @if($isDelete && $city->isHasMany())
                                                <button data-target="DeleteCity{{ $city->id_city }}" title="حذف" class="hover:text-meta-1 button-icon">
