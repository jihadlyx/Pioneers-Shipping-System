<div id="DeleteTrashBranch{{ $branch->id_branch }}" x-transition=""
    ...
    <div class="w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
        ...
        <p class="mb-10 font-medium">
            اذا قمت بحذف هذ الفرع فسيتم حذفه نهائيا
        </p>
        <div class="-mx-3 flex flex-wrap gap-y-4">
            ...
            <div class="w-full px-3 2xsm:w-1/2">
                <form action="{{ route('branches.delete', ['page_id' => $id_page, 'id_branch' => $branch->id_branch]) }}" method="POST">
                    @csrf
                    @method("DELETE")
                    <button type="submit"
