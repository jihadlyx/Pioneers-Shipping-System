    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex text-lg font-medium flex-wrap items-center gap-3">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="/branches">
            ...
            <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                ...
                <div class="datatable-top">
                    ...
                    <div class="datatable-search">
                        <input class="datatable-input" maxlength="55" placeholder="بحث..." type="search" title="البحث عن عنصر في الجدول"
                    ...
                    <table class="datatable-table table w-full table-auto" id="dataTableOne">
                        <thead>
                            <tr>
                                ...
                                <th data-sortable="true" style="width: 4.549511854951188%">
                                    <a href="#" class="datatable-sorter">
                                        <div class="flex items-center gap-1.5">
                                            <p> الحالة </p>
                                        </div>
                        ...
                        @foreach($branches as $index => $branch)
                            <tr data-index="{{ $index }}">
                                    <td class="px-4 py-5 h-full">
                                        <div class="text-gray-100 flex items-center gap-1">
                                            ...
                                            @if($isDelete && $branch->isHasMany())
                                             ...
                                             @endif
                                            @if($branch->hasValidShipments())
                                                <button data-target="translate{{ $branch->id_branch }}" title="تسليم" class="hover:text-meta-3">
                                    ...
                                    @include('site.branches.modal.delete')
                                    @include('site.branches.modal.edit')
                                    @include('site.branches.modal.closeBranch')
                                </tr>
                        @endforeach
