                            ...
                            <tr data-index="0">
                                <td class="px-4 py-5 h-full">
                                    <div class="text-gray-100 flex items-center gap-1">
                                        <button data-target="EditBranch" class="hover:text-primary">
                                        ...
                                        <button data-target="DeleteBranch" class="hover:text-meta-1 button-icon">
                                ...
                                <td>
                                    <button type="submit"
                                        ...
                                        <a href="{{ route('branches.pricesView', 1) }}">
                                            سعر التوصيل
                                        </a>
                                    </button>
                                </td>
