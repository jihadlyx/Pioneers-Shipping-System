    ...
    <div class="data-table-common data-table-one max-w-full overflow-x-auto">
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            <div class="flex items-center gap-1 border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <a href="/DeliveryPreices.addFormPrices" data-target="AddPrice"
                        ...
                        <tr data-index="0">
                            <td class="px-4 py-5">
                                <div class="text-gray-100 flex items-center gap-1">
                                    <button data-target="EditPrice"
                                        class="modal-show hover:text-primary button-icon-edit">
                                        <svg class="fill-current icon" viewBox="0 0 18 18"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button data-target="DeletePrice"
                                        class="modal-show hover:text-meta-1 button-icon">
                                        <svg class="fill-current icon" viewBox="0 0 18 18"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <td>لم يتم الرد</td>
                            <?php echo $__env->make('site.branches.modalPrice.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('site..branches.modalPrice.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tr>
                        <tr data-index="1">
                            <td class="px-4 py-5">
                                <div class="text-gray-100 flex items-center gap-1">
