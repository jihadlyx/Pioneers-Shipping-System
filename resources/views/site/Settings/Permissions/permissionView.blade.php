            ...
            <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                <div class="flex items-center gap-1 border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                    <button data-target="AddPermission"
                        class="modal-show flex items-center gap-2 rounded bg-primary px-4.5 py-2 font-medium text-white hover:bg-opaPermission-80">
                    ...
                    @include('site.settings.Permissions.modal.add')
                    @include('site.settings.Permissions.modal.save')
                            ...
                            <tr data-index="0">
                                <td class="px-4 py-5">
                                    <div class="text-gray-100 flex items-center gap-1">
                                        <button data-target="EditPermission" class="hover:text-primary">
                                        ...
                                        <button data-target="DeletePermission" class="hover:text-meta-1 button-icon">
                                ...
                                <td>
                                    <button type="submit"
                                        class="flex w-fit justify-center rounded bg-primary p-3 font-medium text-gray hover:bg-opaPermission-90">
                                        <a href="/matirialPermission">
                                            أذونات
                                        </a>
                                    </button>
                                </td>
                                @include('site.settings.Permissions.modal.delete')
                                @include('site..settings.Permissions.modal.edit')
                            </tr>
                            <tr data-index="1">
                                <td class="px-4 py-5">
                                    <div class="text-gray-100 flex items-center gap-1">
