<div id="EditState{{ $state->status_id }}" x-transition=""
    ...
    <div
        ...
        <form action="{{ route('status.update', ['page_id' => $id_page, 'status_id' => $state->status_id]) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PATCH')
            <div class="p-6.5">
                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                    <div class="w-full xl:w-1/2">
                        ...
                        <input type="text" name="status_id" value="{{ $state->status_id }}" placeholder="ادخل رقم الحالة"
