<div id="EditState{{ $state->id_state }}" x-transition=""
    ...
    <div
        ...
        <form action="{{ route('status.update', ['page_id' => $id_page, 'id_state' => $state->id_state]) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PATCH')
            <div class="p-6.5">
                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                    <div class="w-full xl:w-1/2">
                        ...
                        <input type="text" name="id_state" value="{{ $state->id_state }}" placeholder="ادخل رقم الحالة"
