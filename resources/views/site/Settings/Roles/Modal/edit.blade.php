<div id="EditRole{{ $role->role_id }}" x-transition=""
    ...
    <div
        ...
        <form action="{{ route('roles.update', ['role_id' => $role->role_id, 'page_id' => 7]) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method("PATCH")
            <div class="p-6.5">
                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                    <div class="w-full xl:w-1/2">
                        ...
                        <input type="number" name="role_id" value="{{ $role->role_id }}" placeholder="ادخل رقم الصلاحية"
